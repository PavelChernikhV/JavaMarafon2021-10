...
public class Task2 {
    public static void main(String[] args) {
        ...
        Airplane airplane = new Airplane("Ан - 2",1953,8,20000,12000); //без ввода топлива не запускается программа
        airplane.setYear(1955);                                                            // вопрос куда девается значение 12000?
        airplane.setLength(12);
